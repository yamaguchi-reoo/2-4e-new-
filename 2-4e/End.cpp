...
void End::Draw()const {
	...
	DrawStringToHandle(515, 940 - MoveString * MOVE_SPEED, "–³—¿Œø‰Ê‰¹", 0x000000, EndFont2);
	DrawStringToHandle(470, 1000 - MoveString * MOVE_SPEED, "ŠÃ’ƒ‚Ì‰¹ŠyH–[", 0x000000,EndFont2);

	DrawStringToHandle(505, 1200 - MoveString * MOVE_SPEED, "‰æ‘œ‘fŞ", 0xff0000, EndFont1);

	DrawStringToHandle(510, 1300 - MoveString * MOVE_SPEED, "ƒCƒ‰ƒXƒg‰®", 0x000000, EndFont2);
